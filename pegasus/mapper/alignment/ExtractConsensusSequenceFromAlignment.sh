...
if test $# -lt 3
then
	echo "Usage: $0 refFastaFname inputAlignmentFname outputFname [minDP] [maxDP] [minMapQ] [minBaseQ]"
	echo
	echo "Note:"
...
$samtoolsPath mpileup -C50 -q $minMapQ -Q $minBaseQ -uf $refFastaFname $inputAlignmentFname | $bcftoolsPath view $bcftoolsArguments -c - | $vcfutilsPath vcf2fq -d $minDP -D $maxDP | gzip > $outputFname
