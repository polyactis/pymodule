...
if test $# -lt 2 ; then
	...
	echo ""
	echo "Note:"
	echo "	#. This is a shell program that runs shell commands from shellCommandFile and pipe the stdout to shellOutputFile."
	echo "	#. If gzipOutput is not 0, the output from shellCommandFile will be piped through gzip to shellOutputFile. Default gzipOutput is $gzipOutputDefault."
	echo ""
	echo ""
	echo "Examples:"
