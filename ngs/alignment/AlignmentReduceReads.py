...
Examples:
    #2013.04.12 test on one outdated alignment (--local_realigned 0
    #  --alignment_outdated_index 1)
    %s --ind_aln_id_ls 552 --ref_ind_seq_id 524  --ref_genome_outdated_index 1
         -o dags/ReduceReads/ReduceReadsAln552.xml
        ...
        -J ~/bin/jdk/bin/java --commit --skipDoneAlignment
        --local_realigned 0 --alignment_outdated_index 1
    
    # 2013.04.12 use sequence coverage to filter alignments
    %s 	--sequence_min_coverage 0 --sequence_max_coverage 2
        --ind_seq_id_ls 632-3230  --ind_aln_id_ls 32
        --ref_ind_seq_id 3280 -o dags/ReduceReads/ReduceReads_ISQ632_3230_coverage0_2.xml
        -l hcondor -j hcondor -z localhost -u yh --intervalSize 20000000
        --intervalOverlapSize 0
        ...
        # --ref_genome_version 2 #(optional, as by default, it gets the
        #   outdated_index=0 reference chromosomes from GenomeDB)
...
class AlignmentReduceReads(ParentClass):
    __doc__ = __doc__
    ...
    def isThisAlignmentComplete(self, individual_alignment=None, data_dir=None):
        """
        2013.05.04
            this is to check whether the new and to-be-generated alignment is
                completed already or not.
    ...
    def isThisInputAlignmentComplete(self, individual_alignment=None,
        data_dir=None, returnFalseIfInexitentFile=True, \
        **keywords):
        """
        2013.05.04 
             this checks whether
        ...
        """
        stockAnswer = self.db.isThisAlignmentComplete(
...
if __name__ == '__main__':
    main_class = AlignmentReduceReads
