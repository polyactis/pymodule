...
By default, the first two columns are of type string, thereafter are of type float.
...
class Salon(gtk.Window):
    ...
    def plotXY(self, ax, canvas, liststore, plot_title='', 
        ...
        if x_chosen_ls and y_chosen_ls:	#highlight
            ...
            titleWithStats = yh_matplotlib.constructTitleFromTwoDataSummaryStat(\
                x_ls+x_chosen_ls, y_ls+y_chosen_ls)
        if plot_title:
