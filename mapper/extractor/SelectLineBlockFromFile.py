...
"""
2012.7.30
    This program selects lines specified on the commandline 
        and output them.
...
class SelectLineBlockFromFile(AbstractMapper):
    ...
    option_default_dict.update({
        ('startLineNumber', 1, int): [1, 's', 1, 
            'the 1st line of the chosen block ', ],\
        ('stopLineNumber', 1, int): [1, 't', 1, 
            'the last line to be included', ],\
        })
